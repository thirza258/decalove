...
export function staticBackground(
  ...
  return probe(
    [
      ...
      `${API_BASE}${API_PREFIX}/static/images/bg/${locationId}_afternoon.png`,
      `/images/bg/${locationId}_afternoon.png`,
      `${API_BASE}${API_PREFIX}/static/images/bg/${locationId}_sunset.png`,
      `/images/bg/${locationId}_sunset.png`,
      `${API_BASE}${API_PREFIX}/static/images/bg/${locationId}_evening.png`,
      `/images/bg/${locationId}_evening.png`,
      `${API_BASE}${API_PREFIX}/static/images/bg/${locationId}_night.png`,
      `/images/bg/${locationId}_night.png`,
    ],
    onSettled,
  );
}
